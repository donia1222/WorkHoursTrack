...
`;
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        {/* Benefits Banner - At Top of ScrollView */}
        <View style={styles.benefitsBanner}>
   
          <View style={styles.benefitsBannerContent}>
            <Text style={[styles.benefitsBannerTitle,]}>
              {t('subscription.features.benefits_title')}
            </Text>
            <View style={styles.benefitsBannerList}>
              <View style={styles.benefitBannerItem}>
                <View style={[styles.benefitBannerIcon, { backgroundColor: colors.warning + '30' }]}>
                  <IconSymbol size={20} name="location.fill" color={colors.warning} />
                </View>
                <Text style={[styles.benefitBannerText, { color: colors.textSecondary }]}>
                  {t('subscription.features.auto_timer_gps')}
                </Text>
              </View>
              <View style={styles.benefitBannerItem}>
                <View style={[styles.benefitBannerIcon, { backgroundColor: colors.error + '30' }]}>
                  <IconSymbol size={20} name="doc.text.fill" color={colors.error} />
                </View>
                <Text style={[styles.benefitBannerText, { color: colors.textSecondary }]}>
                  {t('subscription.features.pdf_reports')}
                </Text>
              </View>
              <View style={styles.benefitBannerItem}>
                <View style={[styles.benefitBannerIcon, { backgroundColor: colors.success + '30' }]}>
                  <IconSymbol size={20} name="bell.fill" color={colors.success} />
                </View>
                <Text style={[styles.benefitBannerText, { color: colors.textSecondary }]}>
                  {t('subscription.features.smart_notifications')}
                </Text>
              </View>
              <View style={styles.benefitBannerItem}>
                <View style={[styles.benefitBannerIcon, { backgroundColor: colors.primary + '30' }]}>
                  <IconSymbol size={20} name="message.fill" color={colors.primary} />
                </View>
                <Text style={[styles.benefitBannerText, { color: colors.textSecondary }]}>
                  {t('subscription.features.work_bot')}
                </Text>
              </View>
            </View>
          </View>
            ...
            {Object.entries(allOfferings)
              ...
              .map(([offeringKey, offering]) =>
                offering.availablePackages.map((pkg, index) => {
                  ...
                  // Usar packageType O identifier para máxima compatibilidad
                  ...
                  if (pkg.packageType === 'THREE_MONTH' || pkg.product.identifier === '1981') {
                    // 3 Meses
                    iconColor = "#10b981";
                    ...
                    periodText = t('subscription.packages.duration_suffix.three_months');
                  } else if (pkg.packageType === 'SIX_MONTH' || pkg.product.identifier === 'ente2') {
                    // 6 Meses
                    iconColor = "#f59e0b";
                    ...
                    periodText = t('subscription.packages.duration_suffix.six_months');
                  } else if (pkg.packageType === 'ANNUAL' || pkg.product.identifier === 'ente3') {
                    // 1 Año
                    iconColor = "#8b5cf6";
                    ...
                    periodText = t('subscription.packages.duration_suffix.one_year');
                  } else {
                    // Fallback para productos no identificados
                    console.warn('⚠️ Producto no reconocido:', pkg.product.identifier, 'PackageType:', pkg.packageType);
                    duration = t('subscription.packages.three_months');
                    badgeText = t('subscription.packages.badges.basic');
                    periodText = t('subscription.packages.duration_suffix.three_months');
                  }
